...
class digraphPlot(tk.Canvas, tk.Frame):
    ...
    def Granularity(self):
        ...
        self._adjacency_matrix = array_matrix
        ...
        for i in range(0,10):
            ...
            while True:
                print("matrix size" + str(len(self._adjacency_matrix)))
                matrix_list = [self._adjacency_matrix]
                ...
                for adjacency_matrix in adjacency_matrix_list:
                    ...
                    # Create and save combined data for this iteration
                        ...
                        print('here is 0 nodes: ' + str(self.find_completely_isolated_nodes(adjacency_matrix)))
                        largest_diameter = 0
            ...
            print(1211111111111111111111111111)
            print(final_data_2)
            print(1211111111111111111111111111)
            print(final_data_2)
            print(1211111111111111111111111111)
